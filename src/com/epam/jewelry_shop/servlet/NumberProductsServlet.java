 ...
 */
@WebServlet("/numberProductsServlet")
public class NumberProductsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public NumberProductsServlet() {
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		session.setAttribute("numberProducts", Integer.parseInt(request.getParameter("numberProducts")));
